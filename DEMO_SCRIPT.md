...
Rehearse this 3 times before any interview. The goal is not to show every feature. The goal is to land three points: you found AED 23.5M at stake, the AI cannot fabricate a number, and you built it solo.
...
"It flagged 294 SKUs with AED 23.5 million at stake. That breaks down into three categories."
...
"Two layers, strictly separated. A Python analytics core computes every metric: days of inventory, excess above order-up-to, FEFO expiry risk, stockout shortfall. All of that is tested against hand-verified fixtures, 84 automated tests."
